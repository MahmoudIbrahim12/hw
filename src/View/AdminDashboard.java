...
public class AdminDashboard extends Stage{
    ...
    private Scene createAccountsScene;
    ...
    public AdminDashboard() throws IOException {
        ...
        accountsManagmentScene = new Scene(accountsRoot);
         ...
         FXMLLoader createAccountLoader = new FXMLLoader(getClass().getResource("AdminFXML/createAccounts.fxml"));
        Parent createAccountRoot = createUserLoader.load();     
        createAccountsScene = new Scene(createAccountRoot);
